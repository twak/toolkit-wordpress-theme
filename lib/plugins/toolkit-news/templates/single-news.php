...
if (have_posts()): while (have_posts()) : the_post(); ?>		
		...
		<div class="wrapper-sm wrapper-pd text-center">
		    ...
		    <p class="heading-related">
		        <?php the_terms($post->ID, 'news_category', '<span class="name-divider">', ', ', '</span>'); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class('wrapper-xs wrapper-pd article'); ?>>
		   ...
		   <div class="social-share" id="social-share">
			...
			<?php the_terms($post->ID, 'news_tag', '<ul class="list-related"><li class="title">Tags:</li><li>', '</li><li>', '</li></ul>'); ?>
