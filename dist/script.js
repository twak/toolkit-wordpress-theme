...
+ function ($) {
     ...
     *
     ...
     Change log:
     1/10/16 : JavaScript Cookie v2.1.2
    ...
    var PluginApi = {
        ...
        addMarker: function(map, markerArray, infowindow, lat, lng, iconURL, markerTitle, markerText, markerType, markerID, infoWindowOpen) {
            ...
            var marker = new mapMarker({
                ...
                draggable: false,
                icon: pinImage,
                content: '<div class="marker" data-mapid="' + markerID + '"><img src="../img/' + iconURL + '.png?v=1" width="30" height="30"/><i class="map-icon grow"><span class="title"></span></i></div>',
            });
...
$(document).ready(function(){
    ...
    // $('.tk-nav-tabs a').on("click", function(){
    //     var $this = $(this);
    //     if($this.parent().hasClass('active')){
    //         //$(this).closest('.tk-nav-tabs').addClass('hello');
    //         console.log('1');
    //     } else {
    //         console.log('0');
    //     }
